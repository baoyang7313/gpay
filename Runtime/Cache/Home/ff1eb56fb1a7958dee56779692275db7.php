        ...
        <div class="demo">
            <div class="accordion">
                <?php if(!empty($orders)): if(is_array($orders)): foreach($orders as $key=>$v): if(($v['pay_state']) >= "1"): ?><div class="accordion-handle">
                                <h4>
                                    <p class="accmrp">买入金额：<?php echo ($v['pay_nums']); ?>RMB<span class="acco_con_spana" >已选择收款人</span></p>
                            ...
                            <div class="accordion-handle" id="<?php echo ($v[id]); ?>">
                                <h4>
                                    <p class="accmrp">买入金额：<?php echo ($v['pay_nums']); ?>RMB<span >未选择收款人</span></p>
                                    <p><?php echo (date("Y-m-d H:i:s",$v['pay_time'])); ?><span></span>
                                    <a href="javascript:void(0)" onclick="revoke(this)" data-id ='<?php echo ($v[id]); ?>'>撤销</a>
                                    </p>
                                </h4>
                                <i></i>
                            </div>
