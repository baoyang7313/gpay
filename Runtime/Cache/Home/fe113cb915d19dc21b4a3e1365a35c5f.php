...
<html lang="zh-CN">
    ...
    <body class="bg96">
        ...
        <div class="header">
            ...
            <div class="header_c"><h2><?php echo (L("balancerecord")); ?></h2></div>
                ...
                <div class="scroller">
                    <ul>
                        <?php if(is_array($Chan_info)): foreach($Chan_info as $key=>$v): ?><li>
                            <?php if(($v['get_type']) == "0"): if(($v['trtype']) == "1"): ?><p><?php echo (L("turnout")); ?></p>
                                    <p><?php echo ($v['get_nums']); ?></p>
                                <?php else: ?>
                                    <p><?php echo (L("turnin")); ?></p>
                                    <p><?php echo ($v['get_nums'] * 80 /100); ?> </p><?php endif; ?>
                            <?php else: ?>
                                <?php if(($v['get_type']) == "5"): ?><p><?php echo (L("guamai1")); ?></p>
                                    <p>-<?php echo ($v['get_nums']); ?></p><?php endif; ?>
                                <?php if(($v['get_type']) == "6"): ?><p><?php echo (L("guamai2")); ?></p>
                                    <p><?php echo ($v['get_nums']); ?></p><?php endif; ?>
                                <?php if(($v['get_type']) == "7"): ?><p><?php echo (L("guamai3")); ?></p>
                                    <p><?php echo ($v['get_nums']); ?></p><?php endif; ?>
                                <?php if(($v['get_type']) == "2"): ?><p><?php echo (L("balancerelease")); ?></p>
                                <p><?php echo ($v['get_nums']); ?></p><?php endif; endif; ?>
