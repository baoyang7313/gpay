...
<html lang="zh-CN">
    ...
    <body class="bg96" style="margin-bottom: 20px;">
        <div class="header_home">
            <!--<div class="userInfo" style="width: 75%">-->
                ...
                <!--<div class="uid_xy">-->
                    ...
                    <!--<p><?php echo (L("credit")); ?>-->
                    <!--<?php $__FOR_START_16813__=0;$__FOR_END_16813__=$uinfo['user_credit'];for($i=$__FOR_START_16813__;$i < $__FOR_END_16813__;$i+=1){ ?>-->
        ...
        <div class="gj">
            <ul>
                <li><a href=""><img src="/Public/home/wap/images/gj.png"><marquee style="line-height:100%;height:100%;width: 90%;"><p><?php echo (L("index_gonggao")); ?></marquee></p></a></li>
            </ul>
        </div>
...
<!--&lt;!&ndash;                <a onClick="BSL.Qcode('0', 'qrcodeCallback')" class="shaom">-->
            ...
            <div class="cen_icon">
                ...
                <div class="f-news-img">
                    <img src="/Public/home/wap/images/f_news.png">
...
<script>
    ...
    function  hdr() {
        hdrcli=function (e) {
            ...
            ftrli.siblings().children("a").children(".ftrimg").children(".qianimg").removeClass("yin");
            ftrli.siblings().children("a").children(".ftrimg").children(".houimg").removeClass("xian");
        ...
        <footer class="ftr">
            ...
            <ul class="bottom" id="bottom">
                ...
                <li onclick="hdrcli(1)" class="ftrli" id="hq_tip">
                    <a>
                        <div class="ftrimg">
