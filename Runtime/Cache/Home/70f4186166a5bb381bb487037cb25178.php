...
<div class="big_width100">
    ...
    <div class="buy_aminy">
        ...
        <?php if(($morecars['card_number']) == ""): ?><!--未添加银行卡-->
            ...
            <?php else: ?>
            <div class="haveCard" style="margin-top:10%;float: left;">
                ...
                if (i == 6) {
                    setTimeout(function () {
                        ...
                        $.ajax({
                            url:'/Growth/Purchase',
                            type:'post',
                            data:{'sellnums':sellnums,'pwd':pwd,'cardid':cardid,'isadd':0},
                            datatype:'json',
                                    ...
                                    layer.confirm(mes.message,{
                                        ...
                                        //创建新订单
                                         $.ajax({
                                            url:'/Growth/Purchase',
                                            type:'post',
                                            data:{'sellnums':sellnums,'pwd':pwd,'cardid':cardid,'isadd':1},
                                            datatype:'json',
                                            success:function (mes) {
                                                    msg_alert(mes.message);                                                
                                            }
