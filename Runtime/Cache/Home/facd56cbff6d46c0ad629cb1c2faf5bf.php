...
<title><?php echo (L("addbank_card")); ?></title>
...
<div class="header">
	...
	<div class="header_c"><h2><?php echo (L("add_card")); ?></h2></div>
	<div class="header_r"></div>
</div>

<div class="big_width100">
	<div class="tips">*<?php echo (L("bank_tip")); ?></div>
	<div class="add_bank_add_gr">
		<div class="fill_sty add_gr_b10">
			<p><?php echo (L("card_name")); ?></p>
			<input type="text" name="other_account" placeholder="<?php echo (L("relname")); ?>" autocomplete="off" id="crkxm">
		</div>
		<div class="fill_sty add_gr_b10">
			<p><?php echo (L("bank")); ?></p>
			<div class="demo">
				<select class="select" isval="true" msg="<?php echo (L("kfh")); ?>" id="khy">
					<option value="0" selected><?php echo (L("kfh")); ?></option>
		...
		<!--开户名-->
		<div class="fill_sty add_gr_b10">
			<p><?php echo (L("card_number")); ?></p>
			<input type="text" name="other_account" placeholder="<?php echo (L("card_number")); ?>" autocomplete="off" id="yhk">
		</div>
		<div class="fill_sty add_gr_b10 mababno">

			<p><?php echo (L("bank_zh")); ?></p>
			<input type="text" name="other_account" placeholder="<?php echo (L("zhname")); ?>" autocomplete="off" id="khzy">
		</div>
	</div>

	<label class="label_check" for="checkbox-01">
		<input name="sample-checkbox-01" id="checkbox-01" value="1" type="checkbox" checked=""><?php echo (L("bank_default")); ?>
	</label>

	<div class="buttonGeoup">
		<a href="#" class="not_next" id="confirm"><?php echo (L("bank_ok")); ?></a>
	</div>
