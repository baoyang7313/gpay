...
<div class="member-top">
    ...
    <div class="member-info">
        ...
        <div class="user-name"><span style="left:35%;"><?php echo ($member['username']); ?>
            <a href="<?php echo U('Shop/Member/verify');?>"><sup>升级商家</sup>
            </a>
        </span></div>
    </div>
...
<div class="user-order-box">
    <dl>
        <a href="<?php echo U('Member/allorder',array('s'=>0));?>">
            <dt>
                <strong>全部订单</strong>
                <span>查看全部订单</span>
            </dt>
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo U('Member/allorder',array('s'=>3));?>">
        ...
        <li>
            <a href="<?php echo U('Member/allorder',array('s'=>1));?>">
                <div class="user_order">
                    <i class="iconfont">&#xe775;</i>
                </div>
                <span>待发货</span>
        ...
        <li>
            <a href="<?php echo U('Member/allorder',array('s'=>2));?>">
                <div class="user_order">
                    <i class="iconfont">&#xe775;</i>
                </div>
                <span>待收货</span>
...
<!-- <li>
    <a href="<?php echo U('Member/allorder',array('s'=>3));?>">
        ...
        <li>
            <a href="<?php echo U('Member/allorder');?>">
                <div class="user_order">
                    <i class="iconfont">&#xe605;</i>
                </div>
                <span>退换货</span>
...
<!--     <a href="<?php echo U('Member/collection');?>">
    <em class="goods-collection-icon"></em>
    <dl>
        <dt>我的收藏</dt>
        <dd>商品收藏/店铺收藏</dd>
    </dl>
 ...
 -->
    <!--<a href="">-->
    <!--<em class="groupon-icon"></em>-->
    <!--<dl>-->
    <!--<dt>我的拼团</dt>-->
    <!--<dd></dd>-->
    <!--</dl>-->
    <!--</a>-->
     <!-- <a href="<?php echo U('Member/myAward');?>"> -->
      <a href="###">
        <em class="exchange-icon"></em>
        <dl>
            <dt>我的奖金</dt>
            <dd></dd>
        </dl>
    </a>
    <a href="<?php echo U('Member/moneydets');?>">
        <em class="exchange-icon"></em>
        <dl>
            <dt>商城收益</dt>
            <dd></dd>
    ...
    <!--<a href="<?php echo U('Member/Tixiandecors');?>">-->
        <!--<em class="bargain-icon"></em>-->
        <!--<dl>-->
            <!--<dt>提现记录</dt>-->
            <!--<dd></dd>-->
        <!--</dl>-->
    <!--</a>-->
    <!---->
    <a href="<?php echo U('Member/addresslist');?>">
        <em class="consignee-address-icon"></em>
        <dl class="border_bottm">
            <dt>收货地址</dt>
            <dd style='color: red;'>添加/修改</dd>
        </dl>
    </a>
            <a href="<?php echo U('Shop/Member/Mineorders');?>">
            <em class="groupon-icon"></em>
            <dl>
                <dt>我的订单</dt>
            </dl>
    ...
    <!--</dl>-->
    <!--</a>-->
    <!--<a href="<?php echo U('Member/Personal');?>">-->
        <!--<em class="user-info-icon"></em>-->
        <!--<dl>-->
            <!--<dt>个人资料</dt>-->
            <!--<dd>查看/修改</dd>-->
        <!--</dl>-->
...
<a href="<?php echo U('Member/verify');?>">
        <em class="user-info-icon"></em>
        <dl>
            <dt>认证中心</dt>
    ...
    <?php if(($member['status']) == "1"): ?><a href="<?php echo U('Shop/Home/Business');?>">
            <em class="product-upload-icon"></em>
            <dl>
                <dt>产品上传</dt>
            </dl>
        </a>

        <a href="<?php echo U('Shop/Home/Minepros');?>">
            <em class="product-manage-icon"></em>
            <dl>
                <dt>产品管理</dt>
            </dl>
        </a>

        <a href="<?php echo U('Shop/Dianpu/dp_info');?>">
            <em class="myshop-icon"></em>
            <dl>
                <dt>我的店铺</dt>
            </dl>
        </a><?php endif; ?>
...
<!--<div class="uset-center-content">-->
<!--<a href="">-->
<!--<em class="btn-popularize-icon"></em>-->
<!--<dl>-->
<!--<dt>我的推广</dt>-->
<!--<dd></dd>-->
<!--</dl>-->
<!--</a>-->
<!--<a href="">-->
<!--<em class="btn-recommend-icon"></em>-->
<!--<dl>-->
<!--<dt>我的推荐</dt>-->
<!--<dd></dd>-->
<!--</dl>-->
<!--</a>-->
<!--<a href="">-->
<!--<em class="btn-distribution-icon"></em>-->
<!--<dl>-->
<!--<dt>申请合伙人12</dt>-->
<!--<dd></dd>-->
<!--</dl>-->
...
<!--<div class="uset-center-content">-->
<!--<a href="">-->
<!--<em class="btn-shop-apply-icon"></em>-->
<!--<dl>-->
<!--<dt>商家入驻</dt>-->
<!--</dl>-->
<!--</a>-->
...
<!--<a href="">-->
<!--<em class="btn-recommend-shop-icon"></em>-->
<!--<dl>-->
<!--<dt>推荐店铺</dt>-->
<!--</dl>-->
<!--</a>-->
<!--</div>-->
<div class="uset-center-content">
    <a href="<?php echo U('Member/loginout');?>">
        <em class="sign-off-icon"></em>
        <dl>
            <dt>注销登录</dt>
        </dl>
    </a>
