...
<head>
    ...
    <!-- Demo styles -->
    <script type="text/javascript" src="/Public/home/common/layerlayer.js"></script>
	<script>
$(function(){
...
<div class="allder">
  <ul>
  <li <?php if($s == 5): ?>class="dianjb"<?php endif; ?> ><a href="<?php echo U('Member/allorder',array('s'=>5));?>">全部订单</a></li>
    ...
    <li style="float: right;"><a href="">编辑</a></li>
